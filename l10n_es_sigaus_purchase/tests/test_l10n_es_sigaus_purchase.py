...
class TestL10nEsSigausPurchase(TestL10nEsSigausCommon):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.product_sigaus_no.purchase_method = "purchase"
        cls.product_sigaus_in_product.purchase_method = "purchase"
        cls.product_sigaus_in_category.purchase_method = "purchase"
        cls.product_sigaus_in_category_excluded.purchase_method = "purchase"
        cls.product_sigaus_no_weight.purchase_method = "purchase"
