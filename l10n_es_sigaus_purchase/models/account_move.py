...
class AccountMove(models.Model):
    ...
    def copy(self, default=None):
        ...
        purchase_lines_data = []
        if self.is_sigaus and self.invoice_line_ids:
        ...
        # Restaurar purchase_order_id en las líneas copiadas y crear líneas SIGAUS
        if purchase_lines_data and new_move.is_sigaus and new_move.sigaus_is_date:
            ...
            if purchase_product_lines:
                ...
                # para cada pedido
                new_move.invoice_line_ids.filtered(lambda line: line.is_sigaus).unlink()
