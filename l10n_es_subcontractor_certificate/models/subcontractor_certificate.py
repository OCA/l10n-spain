...
EXPIRED_WARNING_AEAT = {
    "title": _("Warning!"),
    "message": _("The AEAT certificate for this supplier " "has expired"),
}

REQUIRED_WARNING_AEAT = {
    "title": _("Warning!"),
    "message": _("The AEAT certificate is required and " "expiration date is not set"),
}

EXPIRED_WARNING_SS = {
    "title": _("Warning!"),
    "message": _("The SS certificate for this supplier " "has expired"),
}

REQUIRED_WARNING_SS = {
    "title": _("Warning!"),
    "message": _("The SS certificate is required and " "expiration date is not set"),
}
