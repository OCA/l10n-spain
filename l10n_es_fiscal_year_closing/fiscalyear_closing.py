...
class FiscalyearClosing(orm.Model):
    ...
    def _get_closing_fiscalyear_id(self, cr, uid, context):
        ...
        fiscalyear_ids = self.pool['account.fiscalyear'].search(cr, uid, [
    ...
    def _get_lp_period_id(self, cr, uid, fyc, context):
        ...
        """
        period_ids = self.pool['account.period'].search(cr, uid, [
    ...
    def action_confirm(self, cr, uid, ids, context=None):
        ...
        for fyc in self.browse(cr, uid, ids, context):
            ...
            for move in moves:
                ...
                # change the reconcile option of an account in the future)
