...
NAME_RESTRICTIVE_REGEXP = re.compile(u"^[a-zA-Z0-9\sáÁéÉíÍóÓúÚñÑçÇäÄëËïÏü" + \
                                     "ÜöÖàÀèÈìÌòÒùÙâÂêÊîÎôÔûÛ\.,-_&'´\:;:/]*$",
                                     re.UNICODE | re.X)
...
class l10n_es_aeat_mod349(orm.Model):
    ...
    _defaults = {
        ...
        ##
        ## AEAT brings number (previous number), so
        ##take defautl value as 349 (need to be changed)
        'number': lambda *a: '349'
    }
