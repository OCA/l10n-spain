...
#
# Corregido para instalación OpenERP 5.0.0 sobre
# account_payment_extension: Zikzakmedia S.L. 2009
#   Jordi Esteve <jesteve@zikzakmedia.com>
#
# Adaptación para instalación OpenERP 6.0.0 sobre
# account_payment_extension: Zikzakmedia S.L. 2010
#   Jordi Esteve <jesteve@zikzakmedia.com>
#
...
class PaymentMode(orm.Model):
    ...
    _columns = {
        ...
        'inc_domicile': fields.boolean(
            'Include domicile',
            help='Add partner domicile records to the exported file (CSB 58)'),
        # Usar formato alternativo para el registro de domicilio
        'alt_domicile_format': fields.boolean(
            'Alt. domicile format', help='Alternative domicile record format'),
        ...
        'text1': fields.char(
            'Line 1', size=36,
            help='Enter text and/or select a field of the invoice to include '
                 'as a description in the letter. The possible values ​​are: '
                 '${amount}, ${communication}, {communication2}, {date}, '
        ...
        'text3': fields.char(
            ...
            help='Enter text and/or select a field of the invoice to include '
                 ...
                 '${amount}, ${communication}, {communication2}, {date}, '
                 '{ml_maturity_date}, {create_date}, {ml_date_created}'),
        'payroll_check': fields.boolean(
            'Payroll Check',
            help='Check it if you want to add the 018 data type in the file '
        ...
        'cost_key': fields.selection(
            [('payer', 'Expense of the Payer'),
             ('recipient', 'Expense of the Recipient')], 'Cost Key'),
        'concept': fields.selection(
            [('payroll', 'Payroll'),
             ('pension', 'Pension'),
             ('other', 'Other')], 'Concept of the Order',
            help="Concept of the Order."),
        'direct_pay_order': fields.boolean('Direct Pay Order',
                                           help="By default 'Not'."),
