        ...
        def _parties_facturae():
            ...
            def create_administrative_centres(address, code):
                ...
                if administrative:
                    ...
                    if code == '01':
                        texto += (
                            "<CentreCode>" + address.oficina_contable[:10] +
                            "</CentreCode>")
                    elif code == '02':
                        texto += (
                            "<CentreCode>" + address.organo_gestor[:20] +
                            "</CentreCode>")
                    elif code == '03':
                        texto += (
                            "<CentreCode>" + address.unidad_tramitadora[:20] +
                            "</CentreCode>")
                    elif code == '04':
                        texto += (
                            "<CentreCode>" + address.organo_proponente[:20] +
                            "</CentreCode>")
                    else:
