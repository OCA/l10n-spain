...
class l10n_es_aeat_mod347_report(orm.Model):
    ...
    def button_export(self, cr, uid, ids, context=None):
        ...
        export_obj._export_boe_file(cr, uid, ids, self.browse(cr,
                                                              uid,
                                                              ids and ids[0]))
        return True
    ...
    _columns = {
        ...
        'group_by_cif': fields.boolean('Group by cif'),
    ...
    _defaults = {
                 ...
                 ## AEAT brings number (previous number), so take default value as 349 (need to be changed)
                 'number': lambda *a: '347'
    }
...
class l10n_es_aeat_mod347_report_add_partner_records(orm.Model):
    """
...
class l10n_es_aeat_mod347_real_state_record(orm.Model):
    ...
    _defaults = {
        'report_id': lambda self, cr, uid, context: context.get('report_id',
                                                                None),
        'partner_id': lambda self, cr, uid, context: context.get('partner_id',
                                                                 None),
        'partner_vat': lambda self, cr, uid, context: context.get('partner_vat',
                                                                  None),
        'representative_vat': lambda self, cr, uid, context: context.get('representative_vat',
                                                                         None),
    }
    ...
    def on_change_partner_id(self, cr, uid, ids, partner_id):
        ...
        return  {
            'value': {'partner_vat': partner_vat}
            }
l10n_es_aeat_mod347_real_state_record()


class l10n_es_aeat_mod347_report_add_real_state_records(orm.Model):
    """
...
class l10n_es_aeat_mod347_partner_record_add_real_state_records(orm.Model):
    """
...
class l10n_es_aeat_mod347_partner_record_add_cash_records(orm.Model):
    """
