...
class l10n_es_aeat_mod347_partner_record(osv.osv):
    ...
    _columns = {
        ...
        'bussiness_real_state_rent': fields.boolean('Bussiness Real State Rent', help="Set to identify real estate rent operations aside from the rest. You'll need to fill in the real estate info only when you are the one that receives the money."),
