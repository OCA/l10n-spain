...
class TicketBAIInvoice(models.Model):
    ...
    previous_tbai_invoice_id = fields.Many2one(
    ...
    qr_url = fields.Char('URL', compute='_compute_tbai_qr',
    ...
    * Total Tax Amount: 21 €
    ...
    def build_detalle_no_exenta(self):
        ...
        for tax in not_exempted_taxes:
            ...
            if tax.not_exempted_type == "S1":
                ...
                not_exempted_taxes_not_isp.setdefault(
                ...
                not_exempted_taxes_isp.setdefault(
                    "DesgloseIVA", {"DetalleIVA": []})
    ...
    def build_tipo_desglose(self):
        ...
        if 0 == len(self.tbai_customer_ids):
            ...
            country_codes = list(
                set(self.tbai_customer_ids.mapped('country_code')))
