...
.. |badge3| image:: https://img.shields.io/badge/github-OCA%2Fl10n--spain-lightgray.png?logo=github
    :target: https://github.com/OCA/l10n-spain/tree/19.0/delivery_mrw
    :alt: OCA/l10n-spain
.. |badge4| image:: https://img.shields.io/badge/weblate-Translate%20me-F47D42.png
    :target: https://translation.odoo-community.org/projects/l10n-spain-19-0/l10n-spain-19-0-delivery_mrw
...
-  En la documentación SAGEC versión 2.5 se recoge la información
   ...
   código por si lo volvieran a incluir y se ha escondido el botón
   "Envío Internacional" del formulario del método de envío para que no
   pueda ser seleccionado y evitar confusiones.
...
`feedback <https://github.com/OCA/l10n-spain/issues/new?body=module:%20delivery_mrw%0Aversion:%2019.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `OCA/l10n-spain <https://github.com/OCA/l10n-spain/tree/19.0/delivery_mrw>`_ project on GitHub.
