...
class L10nEsAeatMod390Report(models.Model):
    ...
    casilla_50 = fields.Float(
        ...
        string=u"[50] Total bases imponibles deducibles en operaciones "
               u"interiores de bienes de inversión",
    )
    casilla_51 = fields.Float(
        compute="_compute_casilla_51", store=True,
        string=u"[51] Total de cuotas deducibles en operaciones interiores de "
               u"bienes de inversión",
    )
    ...
    casilla_54 = fields.Float(
        ...
        string=u"[54] Total base deducible importaciones bienes de inversión",
    )
    casilla_55 = fields.Float(
        compute="_compute_casilla_55", store=True,
        string=u"[55] Total cuota deducible importaciones bienes de inversión",
    )
    ...
    casilla_58 = fields.Float(
        ...
        string=u"[58] Total base deducible adq. intracomunitarias bienes de "
               u"inversión",
    )
    casilla_59 = fields.Float(
        compute="_compute_casilla_59", store=True,
        string=u"[59] Total cuota deducible adq. intracomunitarias bienes de "
               u"inversión",
    )
