...
class TestAccountPromissoryNoteCajamar(AccountTestInvoicingCommon):
    @classmethod
    def setUpClass(cls):
    ...
    def test_layout_offered_as_check_layout(self):
        """The module must expose its Cajamar layout where layouts are chosen."""
    ...
    def test_cajamar_report_prints_its_own_block(self):
