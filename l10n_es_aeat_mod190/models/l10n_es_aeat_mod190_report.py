...
class L10nEsAeatMod190ReportLine(models.Model):
    ...
    monetary_perception = fields.Float()
    monetary_withholding = fields.Float()
    perception_in_kind = fields.Float()
    ...
    state_code = fields.Char(
        ...
        help='''''')
    applicable_reduction = fields.Float()
    deductible_expenses = fields.Float()
    compensatory_pension = fields.Float()
    food_annuities = fields.Float()
