...
class L10nEsAeatMod303Report(models.Model):
    ...
    def _compute_return_last_period(self):
        return_last_period_reports = self.filtered(
            lambda x: x.period_type in ("4T", "12")
        )
        (self - return_last_period_reports).return_last_period = False
        return_last_period_reports.return_last_period = True
