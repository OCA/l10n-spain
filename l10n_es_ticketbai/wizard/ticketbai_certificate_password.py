...
class L10nEsTicketBaiCertificatePassword(models.TransientModel):
    _name = 'l10n.es.ticketbai.certificate.password'
    _description = 'Wizard to Load TicketBai Certificate'

    password = fields.Char(string="Password", required=True)

    @api.multi
    def get_keys(self):
        record = self.env['l10n.es.ticketbai.certificate'].browse(
