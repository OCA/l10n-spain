...
class TestL10nEsTicketBAICustomerCancellation(TestL10nEsTicketBAI):
    ...
    def test_out_invoice_cancel(self):
        ...
        root, signature_value = invoice.sudo().tbai_cancellation_ids.get_tbai_xml_signed_and_signature_value()
        res = XMLSchema.xml_is_valid(self.test_xml_customer_cancellation_schema_doc, root)
        self.assertTrue(res)
