...
class AccountTax(models.Model):
    ...
    def tbai_is_subject_to_tax(self):
        s_iva_ns_descriptions = \
            self.env.ref('l10n_es_ticketbai.tbai_tax_map_SNS').tax_template_ids.mapped('description')
        s_iva_ns_b_descriptions = \
            self.env.ref('l10n_es_ticketbai.tbai_tax_map_BNS').tax_template_ids.mapped('description')
