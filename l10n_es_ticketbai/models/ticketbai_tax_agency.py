...
class TicketBAITaxAgency(models.Model):
    ...
    rest_url_customer_invoice = fields.Char(
        string='REST API URL for Customer Invoices',
        compute='_compute_ticketbai_version', store=True)
    rest_url_customer_cancellation = fields.Char(
        string='REST API URL for Customer Invoice Cancellations',
        compute='_compute_ticketbai_version', store=True)
    ...
    def _compute_ticketbai_version(self):
        for record in self:
            ...
            record.rest_url_customer_invoice = \
                tax_agency_version.rest_url_customer_invoice
            record.rest_url_customer_cancellation = \
                tax_agency_version.rest_url_customer_cancellation
