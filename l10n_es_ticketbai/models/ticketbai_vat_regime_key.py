...
class TicketBAIVATRegimeKey(models.Model):
    ...
    * La clave 06 (Régimen especial grupo de entidades en IVA-nivel avanzado) debe ser la
    primera clave a informar cuando concurra con la clave 12.
    * La clave 03 (Régimen especial de bienes usados, objetos de arte, antigüedades y
    ...
    def tbai_get_value_ClaveRegimenIvaOpTrascendencia(self, **kwargs):
        """ V 1.1
