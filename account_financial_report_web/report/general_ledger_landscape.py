...
class general_ledger_landscape(rml_parse.rml_parse):
    _name = 'report.account.general.ledger.cumulative.landscape2'
...
report_sxw.report_sxw('report.account.general.ledger.cumulative.landscape2', 'account.account', 'addons/account_financial_report/report/general_ledger_landscape.rml', parser=general_ledger_landscape, header=False)
