...
class account_balance_reporting_print(report_sxw.rml_parse):
    ...
    def set_context(self, objects, data, ids, report_type=None):
        super(account_balance_reporting_print, self).set_context(objects, data, ids)
...
#         self.localcontext['objects'] = self.objects = objects
    ...
    def __init__(self, cr, uid, name, context):
        ...
        super(account_balance_reporting_print, self).__init__(cr, uid, name, context=context)
        self.localcontext.update({
            'time': time,
            'lines': self._lines,
            '_': self._,
