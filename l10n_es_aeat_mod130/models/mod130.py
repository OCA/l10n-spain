...
class L10nEsAeatMod130Report(models.Model):
    ...
    currency_id = fields.Many2one(
        "res.currency", string="Currency", relation="company_id.currency_id", store=True
    )
    ...
    def calculate(self):
        for report in self:
            ...
            if report.activity_type == "other":
                ...
                vals["casilla_07"] = (
                    vals["casilla_04"] - vals["casilla_05"] - vals["casilla_06"]
                )
            ...
            if report.has_prestamo and vals["casilla_14"] > 0:
                ...
                vals["casilla_16"] = 0.0
            vals["casilla_17"] = (
                vals["casilla_14"] - vals["casilla_15"] - vals["casilla_16"]
            )
            report.write(vals)
        return True
