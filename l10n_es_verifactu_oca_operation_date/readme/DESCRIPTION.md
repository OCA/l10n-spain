...
1.  Sobrescribir \_get_verifactu_invoice_dict_out() para incluir el
    campo FechaOperacion cuando la fecha contable (date) difiere de la
    fecha de factura (invoice_date).
2.  Sobrescribir \_check_verifactu_configuration() para añadir
