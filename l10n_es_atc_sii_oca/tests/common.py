...
class TestL10nEsAtcSiiPayloadBase(TestL10nEsAeatModBase):
    ...
    def _skip_if_no_canary_igic(cls):
        ...
        if not tax_id:
            raise cls.skipTest(
                "Canary IGIC chart (l10n_es / es_canary_pymes) is required "
    ...
    def _art25_invoice_vals(self, **extra):
        vals = {
            "sii_art25_prepayment": "N",
            "sii_art25_document_id": "01",
            "sii_art25_protocol_number": "12345/2026",
            "sii_art25_notary_name": "García López, Juan",
        }
        vals.update(extra)
        return vals

    def _prepare_art25_product(self, tipo_bien="02", exempt_cause="E5"):
        self.product.sii_art25_tipo_bien = tipo_bien
        self.product.sii_exempt_cause = exempt_cause
        return self.product
