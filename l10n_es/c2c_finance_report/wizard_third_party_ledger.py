...
dates_fields = {
	...
	'reconcil':{'string':"Inclure les ecritures reconciliees",'type':'boolean'},
...
class wizard_reportc2c(wizard.interface):
	...
	states = {
		...
		'report': {
			'actions': [],
			'result': {'type':'print', 'report':'account.third_party_ledgerc2c', 'state':'end'}
		}
	}
wizard_reportc2c('account.third_party_ledger.reportc2c')
