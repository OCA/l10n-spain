...
class wizard_report_compared_c2c(wizard.interface):
...
#		data['form']['periods']=p_ids
	...
	states = {
		...
		'report_landscape': {
			'actions': [],
			'result': {'type':'print', 'report':'account.account.balance_comparedc2c', 'state':'end'}
		},
		'report': {
			'actions': [],
			'result': {'type':'print', 'report':'account.account.balance_comparedc2c.landscape', 'state':'end'}
		}
	}
wizard_report_compared_c2c('account.account.balance_comparedc2c')
