...
class general_ledgerc2c(rml_parse.rml_parse):
	_name = 'report.account.general.ledgerc2c'
	...
	def preprocess(self, objects, data, ids):
		...
		super(general_ledgerc2c, self).preprocess(objects, data, new_ids)
	
	def __init__(self, cr, uid, name, context):
		super(general_ledgerc2c, self).__init__(cr, uid, name, context)
		self.query = ""
		self.child_ids = ""
...
report_sxw.report_sxw('report.account.general.ledgerc2c', 'account.account', 'addons/c2c_finance_report/general_ledger.rml', parser=general_ledgerc2c, header=False)
