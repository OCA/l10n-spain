...
class wizard_reportc2c(wizard.interface):
	...
	states = {
		...
		'report_landscape': {
			'actions': [],
			'result': {'type':'print', 'report':'account.general.ledger_landscapec2c', 'state':'end'}
		},
		'report': {
			'actions': [],
			'result': {'type':'print', 'report':'account.general.ledgerc2c', 'state':'end'}
		}
	}
wizard_reportc2c('account.general.ledger.reportc2c')
