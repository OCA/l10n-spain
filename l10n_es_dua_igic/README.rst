...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:38af5df8c598289e5b6a6824e152f524a4c543f49df49d00f554953dbfb0c488
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
2. Asiento factura empresa de tránsito
      ...
      +----------------+--------+--------+----------------+----------------+
      | CUENTA         | DEBE   | HABER  | IMPUESTO       | IMPORTE        |
      |                |        |        |                | IMPUESTO       |
      +================+========+========+================+================+
      | 410000         | 0.00   | 10.50  |                |                |
      | Acreedores     |        |        |                |                |
      +----------------+--------+--------+----------------+----------------+
      | 472700 IGIC    | 10.50  | 0.00   | Importaciones. | 10.50          |
      | Soportado      |        |        | Cuota 7%       |                |
      +----------------+--------+--------+----------------+----------------+
      | 600000 Compras | 0.00   | 150.00 |                |                |
      +----------------+--------+--------+----------------+----------------+
      | 600000 Compras | 150.00 | 0.00   | Importaciones. | 150.00         |
      |                |        |        | Base 7%        |                |
      +----------------+--------+--------+----------------+----------------+
