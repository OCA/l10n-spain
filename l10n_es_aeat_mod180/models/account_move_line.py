...
class AccountMoveLine(models.Model):
    ...
    def _compute_selectable_informacion_catastral_ids(self):
        for line in self:
            ...
            if line.move_id:
                line.selectable_informacion_catastral_ids = line.move_id.partner_id.informacion_catastral_ids
    ...
    def get_grouping_key(self, invoice_tax_val):
        res = super(AccountMoveLine, self).get_grouping_key(invoice_tax_val)
