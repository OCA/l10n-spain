...

{
    ...
    'data': [
        'data/mis_report_balance_abbreviated_summary.xml',
        'data/mis_report_balance_abbreviated_expanded.xml',
        'data/mis_report_pyg_abbreviated_summary.xml',
        'data/mis_report_pyg_abbreviated_expanded.xml',
