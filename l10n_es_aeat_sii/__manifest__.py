...

{
    ...
    "data": [
        ...
        "views/aeat_sii_views.xml",
        "wizards/aeat_sii_password_views.xml",
        # "wizards/account_invoice_refund_views.xml",
        "views/aeat_sii_mapping_registration_keys_views.xml",
        "data/aeat_sii_mapping_registration_keys_data.xml",
        "views/aeat_sii_map_views.xml",
        ...
        "views/aeat_sii_tax_agency_views.xml",
    ],
