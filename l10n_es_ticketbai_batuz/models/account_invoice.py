...
class AccountInvoice(models.Model):
    ...
    def _get_lroe_tax_dict(self, tax_line, sign):
        ...
        if self.company_id.lroe_model == "240":
            # TODO: implementar algo como amount_company del SII para distinta moneda
            tax_dict = OrderedDict(
                [
                    ...
                    ("CuotaIVASoportada", sign * tax_line.amount),
    ...
    def _get_lroe_invoice_data(self, amount_total):
        self.ensure_one()
        res = OrderedDict([
            ("DescripcionOperacion", self.tbai_description_operation),
