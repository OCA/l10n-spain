...
#    Copyright (c) 2017 - Aselcis Consulting (http://www.aselcis.com)
...
''',
    ...
    'data': [
        ...
        'data/taxes_data.xml',
        'data/aeat_export_mod340_invoice_issued_data.xml',
        'data/aeat_export_mod340_invoice_received_data.xml',
        'data/aeat_export_mod340_data.xml',
    ],
    'installable': True,
}
