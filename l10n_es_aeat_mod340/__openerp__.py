...
Si el plan contable esta instalado recuerde utilizar account_chart_update para actualizar los impuestos.
Contabilidad -> Configuración -> Cuentas -> Actualizar plan de cuentas

Búsqueda de facturas emitidas, recibidas y de inversión.
Exportación a formato de AEAT de facturas emitidas, recibidas y de inversión.
...
Facturas bienes de inversión: la prorrata anual definitiva hay que introducirla a mano una vez calculado el modelo. Integrar con módulo assets
