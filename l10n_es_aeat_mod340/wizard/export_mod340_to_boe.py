...
class L10nEsAeatMod340ExportToBoe(orm.TransientModel):
        ...
        if period_start == period_stop:
            ...
            if period_stop == '03':
                ...
                raise orm.except_orm(
                    "ERROR", _("The period hasn't a valid Mod340 period"))
        # Periodo
    ...
    def _get_formatted_invoice_received(self, cr, uid, report,
        ...
        Format of the record:
            ...
            100         Clave de operación. Constante ' ' para un solo tipo de
                        IVA. Constante 'C' para varios tipos de IVA. TODO
                        Resto de operaciones. Varios tipos impositivos.
            101-108     Fecha de expedición
            109-116     Fecha de operación. Se consigna la misma que
                        expedición. TODO. Fecha del uso del bien.
            117-121     Tipo impositivo
        ...
        for tax_line in invoice_received.tax_line_ids:
            ...
            if len(invoice_received.tax_line_ids) > 1:
                ...
                text += ' '
            # Fecha de expedición
            exp_date = invoice_received.invoice_id.date_invoice
    ...
    def _get_formatted_other_records(self, cr, uid, report, context=None):
        ...
        for invoice_issued in report.issued:
            file_contents += self._get_formatted_invoice_issued(cr, uid,
                                                                report,
                                                                invoice_issued)
