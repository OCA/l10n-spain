...
{
        "name" : "Generación de fichero modelo 349",
        "version" : "1.0",
        "author" : "Pexego",
...
Desarrollado por Luis Manuel Angueira Blanco (Pexego, www.pexego.es) en colaboración con \
Borja López Soilán (Pexego, www.pexego.es) y Jordi Esteve (Zikzakmedia, www.zikzakmedia.com)
    """,
        "depends" : [
            'account',
        ...
        "update_xml" : [
            'mod349_wizard.xml',
            'workflow/mod349_workflow.xml',
            'view/mod349_view.xml',
            'mod349_report.xml',
