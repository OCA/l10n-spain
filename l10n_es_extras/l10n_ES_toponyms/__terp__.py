{
		...
		"description": """Provincias, municipios y códigos postales de España. Permite rellenar automáticamente los campos ciudad y provincia a partir del código postal.""",
		"depends" : ["base"],
