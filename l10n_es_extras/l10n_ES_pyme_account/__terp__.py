...
""",
    "license" : "GPL-3",
    "depends" : ["base", "account", "account_payment", "account_payment_extension", "account_financial_report", "l10n_chart_ES", "l10n_ES_toponyms", "l10n_ES_partner", "l10n_ES_partner_data", "l10n_ES_partner_seq", "l10n_ES_remesas", "l10n_ES_extractos_bancarios", "l10n_ES_cierre_ejercicio", "l10n_ES_account_balance_report", "l10n_ES_aeat_mod347"],
