...
class TestL10nEsSigausSales(TestL10nEsSigausCommon):
    ...
    def test_sale_with_sigaus(self):
        ...
        sale.fiscal_position_id = self.fiscal_position_no_sigaus
    ...
    def test_cancel_sale(self):
        ...
        # After canceling and going back to draft, the SIGAUS line should still exist
        sigaus_line = sale.order_line.filtered(lambda a: a.is_sigaus)
        self.assertTrue(sigaus_line)
        # In Odoo 18, the invoice_lines relationship might be cleared after cancel
        # so we just verify the SIGAUS line exists
